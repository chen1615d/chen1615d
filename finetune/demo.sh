...
python get_embedding_bf.py --task_name GEARS_test --input_type singlecell --output_type gene_batch --pool_type all --tgthighres f1 --data_path ./fine_tunning/data/test.npy --save_path ./examples/GEARS/ --model_path ./models/ --ckpt_name finetuned_model.ckpt --pre_normalized A 
